...
RoCUI_Text_Options_Category_Additional_05 = "Additional 5"
...
RoCUI_Text_Options_Skins_Description = "Change the faction skin used by RoCUI."
...
RoCUI_Text_Options_Sundial_Sound_Description = "Check to play a sound when it's daybreak (6:00 server time) or nightfall (18:00 server time). Uncheck to prevent the sound from playing."
